    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#banner" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Banner</span>
          </a>
          <ul class="sidenav-second-level collapse" id="banner">
            <li>
              <a href="?p=banner">view banner</a>
            </li>
            <li>
              <a href="?p=add_banner">Add banner</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          ...
          <ul class="sidenav-second-level collapse" id="staff">
           <li>
            <a href="?p=academic_staff">Academic staff</a>
          </li>
          <li>
            <a href="?p=supporting_staff">Supporting staff</a>
          </li>
          <li>
            <a href="?p=add_staff">add staff</a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
        ...
        <ul class="sidenav-second-level collapse" id="gallery">
          ...
          <li>
            <a href="?p=del_category">Delete Category</a>
            
          </li>
          <li>
            <a href="?p=add_photo">Add photo</a>
  ...
  <footer class="sticky-footer">
    <div class="container">
      <div class="text-center">
        <small>Copyright © thub 2018</small>
      </div>
    </div>
  </footer>
